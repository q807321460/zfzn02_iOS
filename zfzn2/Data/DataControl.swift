...
let g_dAnimationDuration:TimeInterval = 0.15 //弹出视图的显示时间
let g_dAnimationStartOffset:CGFloat = -10//弹出视图从上方弹出的滑动距离
...
@objc class DataControl: NSObject {
    ...
    let m_arrayElectricImage:NSArray = ["电器类型_插座", "电器类型_一键开关", "电器类型_两键开关", "电器类型_三键开关", "电器类型_四键开关", "电器类型_门锁", "电器类型_窗帘", "电器类型_窗户", "电器类型_摄像头", "电器类型_空调", "电器类型_四键开关", "电器类型_机械手", "电器类型_电视", "电器类型_传感器_温度", "电器类型_传感器_水浸", "电器类型_传感器_门磁", "电器类型_传感器_燃气", "电器类型_传感器_壁挂红外", "电器类型_警号", "电器类型_传感器_烟雾", "电器类型_晾衣架", "电器类型_空调", "电器类型_空调", "电器类型_门锁"]
    let m_arrayElectricLabel:NSArray = ["插座", "一键开关", "两键开关", "三键开关", "四键开关", "门锁", "窗帘", "窗户", "摄像头", "空调", "情景开关", "机械手", "电视", "温度计", "水浸", "门磁", "燃气报警", "壁挂红外", "警号", "烟雾报警", "晾衣架", "学习型空调", "中央空调", "新门锁"]
