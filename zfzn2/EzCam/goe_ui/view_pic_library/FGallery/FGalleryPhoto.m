...
- (void)loadThumbnailInThread_local;
...
- (void)loadThumbnail
{
	...
	// load from disk
		...
		[NSThread detachNewThreadSelector:@selector(loadThumbnailInThread_local) toTarget:self withObject:nil];
	}
}
...
- (void)loadFullsizeInThread
{
	...
	//NSString *path=@"/var/mobile/Applications/C23894BF-67C3-4703-B538-0797DCF24F5C/Documents/ppviewjpg/2014.05.10/2014.05.10-15:02:18.jpg";
...
- (void)loadThumbnailInThread_local
{
    ...
    ///var/mobile/Applications/C23894BF-67C3-4703-B538-0797DCF24F5C/Documents/ppviewjpg/2014.05.10/2014.05.10-15:02:18.jpg
...
- (void)loadThumbnailInThread_net
{
	NSAutoreleasePool *pool = [[NSAutoreleasePool alloc] init];
