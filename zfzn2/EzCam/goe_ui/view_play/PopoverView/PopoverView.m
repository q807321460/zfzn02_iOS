...
#define kDividerColor [UIColor blueColor]

// BACKGROUND GRADIENT

//bottom color white in gradient bg
//#define kGradientBottomColor [UIColor colorWithWhite:0.980f alpha:kBoxAlpha]
#define kGradientBottomColor [UIColor colorWithRed:123.0/255 green:127.0/255 blue:120.0/255 alpha:0.7]

//top color white value in gradient bg
//#define kGradientTopColor [UIColor colorWithWhite:1.f alpha:kBoxAlpha]
#define kGradientTopColor [UIColor colorWithRed:123.0/255 green:127.0/255 blue:120.0/255 alpha:0.7]
