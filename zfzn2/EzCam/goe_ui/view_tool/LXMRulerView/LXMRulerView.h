...
@protocol LXMRulerView_interface <NSObject>
@optional
...
@property (assign) id<LXMRulerView_interface>delegate;
...
@property (nonatomic, assign) CGFloat rulerSpacing;//刻度之间的距离，default is 10;涉及到位置的准确性，所以用整型
