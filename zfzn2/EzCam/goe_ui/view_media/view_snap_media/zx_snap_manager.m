...
//  ppview_zx
//
//  Created by zxy on 15-1-29.
//  Copyright (c) 2015年 vveye. All rights reserved.
//

#import "zx_snap_manager.h"
#include <time.h>
@implementation zx_snap_manager
static zx_snap_manager* instance;
...
+(zx_snap_manager*) getInstance{
    if(instance==nil)
    {
        instance = [[zx_snap_manager alloc] init];
    }
    return instance;
}
        ...
        if ([m_dictionary objectForKey:@"events"]) {
            ...
            for (NSDictionary* dic_0 in [m_dictionary objectForKey:@"events"]) {
                ...
                switch (cur_pic_item.m_event_type) {
                    case 10001:
                        tmp_msg=MYLocalizedString(@"m_event_type_10001",@"");
                        break;
                    case 10002:
                        tmp_msg=MYLocalizedString(@"m_event_type_10002",@"");
                        break;
                    case 10003:
                        tmp_msg=MYLocalizedString(@"m_event_type_10003",@"");
                        break;
                    case 10004:
                        tmp_msg=MYLocalizedString(@"m_event_type_10004",@"");
                        break;
                    case 10005:
                        tmp_msg=MYLocalizedString(@"m_event_type_10005",@"");
                        break;
                    case 10006:
                        tmp_msg=MYLocalizedString(@"m_event_type_10006",@"");
                        break;
                    case 10007:
                        tmp_msg=MYLocalizedString(@"m_event_type_10007",@"");
                        break;
                    case 10008:
                        tmp_msg=MYLocalizedString(@"m_event_type_10008",@"");
                        break;
                    case 10009:
                        tmp_msg=MYLocalizedString(@"m_event_type_10009",@"");
                        break;
                    case 10010:
                        tmp_msg=MYLocalizedString(@"m_event_type_10010",@"");
                        break;
                    case 10011:
                        tmp_msg=MYLocalizedString(@"m_event_type_10011",@"");
                        break;
                    case 10012:
                        tmp_msg=MYLocalizedString(@"m_event_type_10012",@"");
                        break;
                    case 10022:
                        tmp_msg=MYLocalizedString(@"m_event_type_10022",@"");
                        break;
                    default:
                        tmp_msg=MYLocalizedString(@"m_sensor_type_unknown",@"");
                        break;
                }
...
-(int)getCount_pic
{
    return g_ui_tree_pic_array.count;
}
