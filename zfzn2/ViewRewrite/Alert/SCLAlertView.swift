...
public enum SCLAlertViewStyle {
    ...
    var defaultColorInt: UInt {
        ...
        case .notice://灰色，手型
            return 0x727375
        case .warning:
            return 0xFFD110//0x8B2772紫色  原始：0xFFD110,红色
        case .info:
            return 0x8B2772//0x8B2772紫色   原始：0x2866BF,蓝色
        case .edit:
            return 0xA429FF
        case .wait:
            return 0xD62DA5
...
open class SCLAlertView: UIViewController {
    ...
    @discardableResult  open func addButton(_ title:String, backgroundColor:UIColor? = nil, textColor:UIColor? = nil, showDurationStatus:Bool=false, action:@escaping ()->Void)->SCLButton {
    ...
    @discardableResult open func addButton(_ title:String, backgroundColor:UIColor? = nil, textColor:UIColor? = nil, showDurationStatus:Bool = false, target:AnyObject, selector:Selector)->SCLButton {
        let btn = addButton(title, backgroundColor: backgroundColor, textColor: textColor, showDurationStatus: showDurationStatus)
    ...
    @discardableResult fileprivate func addButton(_ title:String, backgroundColor:UIColor? = nil, textColor:UIColor? = nil, showDurationStatus:Bool=false)->SCLButton {
        // Update view height
    ...
    @discardableResult open func showCustom(_ title: String, subTitle: String, color: UIColor, icon: UIImage, closeButtonTitle:String?=nil, duration:TimeInterval=0.0, colorStyle: UInt=SCLAlertViewStyle.success.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: SCLAnimationStyle = .topToBottom) -> SCLAlertViewResponder {
    ...
    // showError(view, title, subTitle)红色的
    ...
    // showWarning(view, title, subTitle)黄色的
    ...
    // showNotice(view, title, subTitle)灰色的 //konnn topToBottom noAnimation
    ...
    // showInfo(view, title, subTitle)紫色的 //konnn topToBottom noAnimation
    ...
    @discardableResult open func showTitle(_ title: String, subTitle: String, style: SCLAlertViewStyle, closeButtonTitle:String?=nil, duration:TimeInterval=0.0, colorStyle: UInt?=0x000000, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: SCLAnimationStyle = .topToBottom) -> SCLAlertViewResponder {
    ...
    @discardableResult open func showTitle(_ title: String, subTitle: String, duration: TimeInterval?, completeText: String?, style: SCLAlertViewStyle, colorStyle: UInt?=0x000000, colorTextButton: UInt?=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: SCLAnimationStyle = .topToBottom) -> SCLAlertViewResponder {
        selfReference = self
        view.alpha = 0
        let rv = UIApplication.shared.keyWindow! as UIWindow
        rv.addSubview(view)
        ...
        case .notice:
            //原始为手型
            iconImage = checkCircleIconImage(circleIconImage, defaultImage:SCLAlertViewStyleKit.imageOfInfo)//imageOfInfo 原始：imageOfNotice
        ...
        if appearance.showCloseButton {
            addButton(completeText ?? "取消", target:self, selector:#selector(SCLAlertView.hideView))
        }
...
class SCLAlertViewStyleKit : NSObject {
    ...
    class func drawWarning() {
        // Color Declarations
        let greyColor = UIColor.white//UIColor(red: 0.236, green: 0.236, blue: 0.236, alpha: 1.000)
