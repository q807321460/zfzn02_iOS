//
//  AddApplianceRoomViewController.m
//  Smart360
//
...
@class SmartHomeViewController;

@interface AddApplianceRoomViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation AddApplianceRoomViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    RightLabelTableViewCell *cell = (RightLabelTableViewCell *) [tableView dequeueReusableCellWithIdentifier:@"AddApplianceRoomTableViewCell"];
    if (!cell) {
        cell = [[RightLabelTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"AddApplianceRoomTableViewCell"];
    }
...
-(void)rightItemClicked:(id)sender{
    ...
    JSDebug(@"addWiFiDevice", @"brandID:%d, roomID:%@, deviceInherentID:%@, name:%@, alias:%@, deviceType:%@",self.applianceModel.brandID,self.selecteRoomModel.roomID,self.applianceModel.deviceInherentID,self.applianceModel.name,self.applianceModel.alias,self.applianceModel.deviceType);
    
    [SBApplianceEngineMgr addWifiDevice:self.applianceModel.brandID roomID:self.selecteRoomModel.roomID deviceInherentID:self.applianceModel.deviceInherentID devName:self.applianceModel.name devAlias:self.applianceModel.alias devType:self.applianceModel.deviceType belongsArray:self.selecteBelongsArray];
